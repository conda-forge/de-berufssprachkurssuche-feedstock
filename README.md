About de-berufssprachkurssuche-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-berufssprachkurssuche-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-berufssprachkurssuche-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-berufssprachkurssuche
# for installing globally
pixi global install de-berufssprachkurssuche
```
...
It is possible to list all of the versions of `de-berufssprachkurssuche` available on your platform:
...
```
pixi search de-berufssprachkurssuche --channel conda-forge
```
